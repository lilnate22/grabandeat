...
public class Renderer {
    ...
    private FoodType currentFood = null;
    ...
    public void play() {
        ...
        while (running) {
            ...
            if (mouse.buttonDown(1)) {
                ...
                FoodType clickFood = state.clickFood(mousePos.x, mousePos.y);
                if (clickFood != null) {
                    System.out.println(clickFood.Name);
    ...
    private void drawFood(java.util.List<FoodType> food) {
        for (FoodType f : food) {
    ...
    private void drawFoodStats(FoodType f) {
        if (f != null) {
            g2d.setColor(Color.BLACK);
            g2d.drawString("Food Calories: " + f.Calories, 500, 100);
        }
    }
